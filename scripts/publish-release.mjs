...
export function collectReleaseAssets({ repository, commit, artifacts, manifest }) {
  ...
  return { assets, prerelease: contractVersion.includes("-"), tag: value.releaseTag };
}
